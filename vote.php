...
<body class="darker">
    ...
    <nav class="navbar navbar-expand-lg navbar-white fixed-top" id="banner">
        <div class="container">
            <!-- Brand -->
            <a class="navbar-brand" href="#"><span><img src="img/core-img/logo.png" alt="logo"></span> DeFi Votes</a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#"  data-toggle="dropdown">Coins</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="auctions.html">ADA</a>
                            <a class="dropdown-item" href="discover.html">FLOKI INU</a>
                            <a class="dropdown-item" href="discover-2.html">PERMA</a>
                        </div>
                    </li>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <nav aria-label="breadcrumb" class="breadcumb--con text-center">
                            <h2 class="title wow fadeInUp" data-wow-delay="0.2s">DEFI VOTES</h2>
      ...
      <div class="row">
        ...
        <div class="container">
            <div class="section-heading text-center">
                ...
                <h2 class="fadeInUp" data-wow-delay="0.3s">3. Select a coin and vote <img src="img/art-work/fire.png" width="20" alt=""></h2>
                <p class="fadeInUp" data-wow-delay="0.4s">our mission is bring atraaction and capitalize interesting projects.</p>
            </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="post-meta">
                                <p>By <a href="#" class="post-author">Nazrul</a> <a href="#">Apr 10, 2021</a> <a href="#" class="post-comments">7 comments</a></p>
                            </div>
                            <a href="index-single-blog.html" class="post-title">
                                <h4>New and Creative NFTs Marketplace for All Digital Asset Needs.</h4>
                            </a>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="index-single-blog.html" class="post-title">
                                <h4>Holly Herndon and Mat Dryhurst on the dreamy decentralized collaboration.</h4>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus fugiat at vitae, ratione sapiente repellat.</p>
                            <a href="index-single-blog.html" class="btn more-btn mt-15">Read Details</a>
                        </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="index-single-blog.html" class="post-title">
                                <h4>Rick Silva on the nature of a not-too-distant future.</h4>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus fugiat at vitae, ratione sapiente repellat.</p>
                            <a href="index-single-blog.html" class="btn more-btn mt-15">Read Details</a>
                        </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="index-single-blog.html" class="post-title">
                                <h4>NFT’s smart contracts are verified and open source.</h4>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus fugiat at vitae, ratione sapiente repellat.</p>
                            <a href="index-single-blog.html" class="btn more-btn mt-15">Read Details</a>
                        </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="index-single-blog.html" class="post-title">
                                <h4>Manual Photo + Raven B. on picturing a whole new world.</h4>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus fugiat at vitae, ratione sapiente repellat.</p>
                            <a href="index-single-blog.html" class="btn more-btn mt-15">Read Details</a>
                        </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="index-single-blog.html" class="post-title">
                                <h4>Guest Blog: Gene Kogan on the art of credit assignment.</h4>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus fugiat at vitae, ratione sapiente repellat.</p>
                            <a href="index-single-blog.html" class="btn more-btn mt-15">Read Details</a>
                        </div>
